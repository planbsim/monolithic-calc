// ATTENTION: Replace all occurences of "???" by the compiler name! 

// ???.cs                                                        HDO, 2006-08-28
// -----
// Main program for compiler generated from ???.atg with Coco-2.
//=====================================|========================================
...
public class ??? {
  ...
  //-----------------------------------|----------------------------------------
    ...
    Utils.InstallModule("???Lex",  new Utils.ModuleMethodDelegate(???Lex.???LexMethod));
    Utils.InstallModule("???Sem",  new Utils.ModuleMethodDelegate(???Sem.???SemMethod));
    Utils.InstallModule("???Syn",  new Utils.ModuleMethodDelegate(???Syn.???SynMethod));
